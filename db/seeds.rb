...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Space+Jam+(1996)+Official+Trailer+-+Michael+Jordan%2C+Bill+Murray+Movie+HD.mp4')
video1.video.attach(io: file, filename: 'extraction.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/spacejam1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/The+Ring+(2002)+Trailer+%231+%7C+Movieclips+Classic+Trailers+1.mp4')
video2.video.attach(io: file, filename: 'thering.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/thering1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Official+Trailer%3A+Just+Go+With+it+(2011).mp4')
video3.video.attach(io: file, filename: 'justgowithit.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/justgowithit1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Extraction.mp4')
video4.video.attach(io: file, filename: 'extraction.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/extraction1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Jeffrey+Epstein%3A+Filthy+Rich+%7C+Official+Trailer+%7C+Netflix.mp4')
video5.video.attach(io: file, filename: 'jeffreyepstein.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/jeffreyepstein2.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/SPIDER-MAN%3A+INTO+THE+SPIDER-VERSE+-+Official+Trailer+%232+(HD).mp4')
video6.video.attach(io: file, filename: 'spiderman.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/spiderman.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/The+Last+Dance+%7C+Relive+the+Phenomenon+%7C+Netflix.mp4')
video7.video.attach(io: file, filename: 'thelastdance.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/thelastdance1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/FYRE%3A+The+Greatest+Party+That+Never+Happened+%7C+Official+Trailer+%5BHD%5D+%7C+Netflix.mp4')
video8.video.attach(io: file, filename: 'fyre.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/fyre2.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/6underground.mp4')
video9.video.attach(io: file, filename: '6underground.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/6underground1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Olympus+Has+Fallen+Official+Trailer+%231+(2013)+-+Morgan+Freeman+Movie+HD.mp4')
video10.video.attach(io: file, filename: 'olympus.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/olympus1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Bad+Boys+II.mp4')
video11.video.attach(io: file, filename: 'BadBoys2.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/badboys21.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Tall+Girl.mp4')
video12.video.attach(io: file, filename: 'tallgirl.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/tallgirl1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/THE+LITTLE+VAMPIRE+Official+Trailer+(2018)+Animated+Movie+HD.mp4')
video13.video.attach(io: file, filename: 'thelittlevampire.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/thelittlevampire1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/The+Croods+-+Trailer.mp4')
video14.video.attach(io: file, filename: 'thecroods.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/thecroods1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/The+Wrong+Missy.mp4')
video15.video.attach(io: file, filename: 'TheWrongMissy.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/thewrongmissy1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Bird+Box.mp4')
video16.video.attach(io: file, filename: 'birdbox.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/birdbox1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Insidious%3A+Chapter+2+Official+Trailer+%231+(2013)+-+Patrick+Wilson+Movie+HD.mp4')
video17.video.attach(io: file, filename: 'insidious.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/insidious22.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Carrie.mp4')
video18.video.attach(io: file, filename: 'carrie.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/carrie2.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/Rim+of+the+World.mp4')
video19.video.attach(io: file, filename: 'rim.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/rim1.png')
...
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/BATTLE+LOS+ANGELES.mp4')
video20.video.attach(io: file, filename: 'battlela.mp4')
file = URI.open('https://viewflix-seeds.s3.amazonaws.com/battlela2.png')
