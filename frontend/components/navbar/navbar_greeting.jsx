...
class NavbarGreeting extends React.Component {
  ...
  render() {
    ...
    if (currentUser && !this.props.videoShow) {
      return (
        <div className="navbar">
          ...
          <div className="right-nav">
            <i
              className="fas fa-search foobar-search"
              onClick={this.handleClick}
            >
              <div
                className={
                  this.state.clicked ? 'search-box-open' : 'search-box-closed'
                }
              >
                <Link to="/search">
                  <SearchContainer />
            ...
            <i className="fab fa-github foobar">
              <ul className="dropdown-menu">
                ...
                <a
                  className="link"
                  href="https://angel.co/u/kevin-espinal"
                  target="blank"
                >
                  <li>AngelList</li>
                </a>
            ...
            <i className="fas fa-bell foobar">
              <ul className="dropdown-menu">
                ...
                <Link className="link" to="videos/4">
                  <li>Extraction</li>
                </Link>
                <Link className="link" to="videos/6">
                  <li>Spiderman</li>
                </Link>
                <Link className="link" to="videos/15">
      ...
      return (
        <div
          className={this.state.hovered ? 'video-nav' : 'video-nav-hidden'}
